...
# Финальная версия 5.18: Промпт доработан для генерации естественного, а не пошагового ответа
...
# --- Финальная, улучшенная функция сборки контекста для ИИ ---
def build_full_context_for_ai(db: Session, session_id: int, user_id: int, current_question: str, options: list, event_type: str = None) -> str:
    ...
    # --- Финальный промпт, разделяющий внутренний анализ и итоговый ответ ---
    system_prompt = (
