...
def build_full_context_for_ai(
    ...
    system_prompt = (
        ...
        "2. **ИТОГОВЫЙ ОТВЕТ ДЛЯ ПОЛЬЗОВАТЕЛЯ (ЕДИНЫЙ АБЗАЦ):** На основе своего анализа, напиши **единый и связный** ответ. Твой ответ должен звучать как совет от уверенного эксперта со своей точкой зрения. **Не используй слова 'Шаг 1', 'Шаг 2' и т.д., не упоминай явно инвестиционную философию**"
    )
